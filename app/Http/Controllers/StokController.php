...
class StokController extends Controller
{
    public function index(){
        ...
        $page = (object) ['title' => 'Daftar stok barang yang terdaftar dalam sistem' ];
    ...
    public function list(Request $request){
        $stoks = StokModel::select('stok_id', 'barang_id', 'user_id', 'stok_jumlah','stok_tanggal')->with('barang', 'user');
    ...
    public function create(){
        ...
        $barang = BarangModel::all(); // ambil data level untuk ditampilkan di form $activeMenu 'user';
        $user = UserModel::all(); // ambil data level untuk ditampilkan di form $activeMenu 'user'; 
        $activeMenu = 'stok'; // set menu yang sedang aktif
