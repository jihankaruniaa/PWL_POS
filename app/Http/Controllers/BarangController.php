...
class BarangController extends Controller
{
    public function index(){
        ...
        $page = (object) ['title' => 'Daftar data barang yang terdaftar dalam sistem' ];
    ...
    public function create(){
        ...
        $kategori = KategoriModel::all(); // ambil data level untuk ditampilkan di form $activeMenu 'user'; 
        $activeMenu = 'barang'; // set menu yang sedang aktif
    ...
    public function store(Request $request){
        $request->validate([
            'barang_kode' => 'required|string|min:2|unique:m_barang,barang_id',
